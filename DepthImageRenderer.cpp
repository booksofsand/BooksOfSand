...
// MM: believe this is for storing the depth image of the sandbox into a 
//     frame buffer, from which depth map values are calculated
...
// MM: what is surface template? is it preparation for rendering color map?
