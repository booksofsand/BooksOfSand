...
DISTDIR = /home/arsandbox/Documents/BooksOfSand/.tmp/Graphics1.0.0
LINK          = g++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents main.cpp sandboxwindow.cpp kinecthandler.cpp $(DISTDIR)/
...
moc_kinecthandler.cpp: config.h \
		...
		kinecthandler.h \
		moc_predefs.h
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/home/arsandbox/Documents/BooksOfSand -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/4.8.5 -I/usr/include/c++/4.8.5/x86_64-redhat-linux -I/usr/include/c++/4.8.5/backward -I/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include -I/usr/local/include -I/usr/include kinecthandler.h -o moc_kinecthandler.cpp
